...
build-flags: build-info
	...
	$(eval BUILD_LDFLAGS += -X 'github.com/yokkkoso/ongaku/internal/build.githash=$(GITHASH)')
	$(eval BUILD_LDFLAGS += -X 'github.com/yokkkoso/ongaku/internal/build.buildstamp=$(BUILD_DATE)')
